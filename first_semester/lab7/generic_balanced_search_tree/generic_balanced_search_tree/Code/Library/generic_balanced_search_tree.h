/*
author: Acs David
file name: generic_balanced_search_tree.h
file creation date: 2017-01-07 13:26:24
*/

#ifndef GENERIC_BALANCED_SEARCH_TREE_H
#define GENERIC_BALANCED_SEARCH_TREE_H
...
typedef struct BTreeNodeTag {
	void* element;
	struct BTreeNodeTag* left;
	struct BTreeNodeTag* right;
}BTreeNodeT;

typedef struct GenericBalancedTreeTag {
	BTreeNodeT* root;
	int nr_of_elements;
	int(*compare)(const void* a, const void* b); // compare function, used to keep the tree invariant.
}GenericBalancedSearchTreeT;

// define your functions here

/*
	Creates an empty generic balanced tree.
...
/*
	...
	GenericBalancedSearchTreeT* tree should be freed afterwards.
